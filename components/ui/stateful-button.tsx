...
export const Button = ({ className, children, loadingContent, ...props }: ButtonProps) => {
  ...
  return (
    ...
    >
      <motion.div layout className="flex items-center gap-2">
        <motion.div className="content flex items-center gap-2" initial={{ opacity: 1, scale: 1 }}>
          {children}
        </motion.div>
        <motion.div
          className="loading-content flex items-center gap-2"
